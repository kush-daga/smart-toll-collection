...
from app.views.ml import Main
from app.views.ml  import Preprocess
from app.views.ml import PossibleChar
...
def loadKNNDataAndTrainKNN():
    ...
    try:
        ...
        npaClassifications = np.genfromtxt("classifications.txt", dtype='float32')
    # 
    ...
    try:
        npaFlattenedImages = np.loadtxt("flattened_images.txt", dtype='float32')                 # read in training images
    except:                                                                                 # if file could not be opened
